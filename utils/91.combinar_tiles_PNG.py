...
Utilitzo aquest script per a combinar tiles en una sola imatge. 

Aquest script està dissenyat per a treballar amb imatges PNG que segueixen un patró de nom específic que inclou coordenades. 
Les funcions principals són:

Paràmetres:
- `tile_dir`: El directori on es troben les imatges de rajoles.
- `output_file`: El camí del fitxer on es guardarà la imatge combinada.
- `subname`: El prefix del nom dels fitxers de rajoles que s'utilitza per identificar-los.
