...
Utilitzo aquest script per a convertir fitxers GeoTIFF en imatges PNG. 
Llegeixo els GeoTIFFs i els guardo com a PNG en un directori de sortida.

Amb cada geotiff:
    - Obre el fitxer GeoTIFF utilitzant rasterio.
    - Si el fitxer té més d'una banda, llegeixo les tres bandes i les utilitza per crear una imatge RGB.
    - Si el fitxer té una sola banda, normalitza les dades a l'interval [0, 255] per a la visualització.
