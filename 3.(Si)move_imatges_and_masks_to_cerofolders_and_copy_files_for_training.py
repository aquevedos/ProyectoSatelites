...
Per tant, utilitzo aquest script per a separar les màscares i les imatges que tenen tot zeros.
Els fitxers de màscares amb tot zeros els tinc identificats amb la paraula "blanks" al nom.
Per tant, només haig de moure les imatges corresponents a un directori que anomeno tot_ceros.

Paràmetres:
    mask_dir (str): Directori que conté els fitxers de màscares.
    tile_dir_august (str): Directori que conté les imatges de rajoles d'agost.
