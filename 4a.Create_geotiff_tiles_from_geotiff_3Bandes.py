...
Utilitzo aquest script per a generar tiles individuals a partir d'un fitxer GeoTIFF d'entrada.
Cada tile conserva la informació de georeferenciació del fitxer original. 
Les bandes RGB del fitxer d'entrada es normalitzen a una escala de 0 a 255.


Paràmetres:
    input_file (str): Ruta al fitxer GeoTIFF d'entrada.
